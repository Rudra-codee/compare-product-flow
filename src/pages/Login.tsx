...
const Login = () => {
  ...
  const handleGoogleLogin = () => {
    ...
    alert('Google login would be implemented with Firebase Auth');
  };
            ...
            <Tabs defaultValue="login" className="w-full">
              ...
              <TabsContent value="login" className="space-y-6">
                <form onSubmit={handleLogin} className="space-y-4">
                  ...
                  <Button 
                    type="submit" 
                    className="w-full gradient-hero text-white hover:opacity-90 py-6 text-lg font-semibold"
                    disabled={isLoading}
                  >
                ...
                <Button 
                  ...
                  className="w-full border-border hover:bg-muted py-6 text-lg"
                >
